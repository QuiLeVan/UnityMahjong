...
public class SceneManager : MonoBehaviour
{
    ...
    void Awake()
    {
        DebugHelper.log("Implement Init Ads");
        ...
        DebugHelper.log("Implement Callback Ads");
    ...
    {
        DebugHelper.log("Implement Load New Interstial ads");
    ...
    void Update()
    {
        ...
        if (_preTimeCheckHide > 2f && !checkHide)
        {
            ...
            {
                DebugHelper.log("Implement HideBanner");
                // Banner.HideBanner();
                checkHide = true;
            }
        }
    ...
    {
        DebugHelper.log("Implement ShowIntertitialBanner");
    ...
    public void ShowVideoAds() {
        if (IsLoadVideosSuccess) {
            DebugHelper.log("Implement Show Video rewards");
